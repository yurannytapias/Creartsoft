"""
Django settings for Creartsoft project.
...
SECRET_KEY = 'django-insecure-kcoeegbpbv#b8^8x8_5xs9cy%p44^3pmo-w$tg#n#&ftcpo-g@'
...
WSGI_APPLICATION = 'Creartsoft.wsgi.application'
